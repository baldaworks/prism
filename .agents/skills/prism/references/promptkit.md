...
for Prism Callee agents under `.callee/prism/`.

Regenerate Roles with `callee promptkit role create` (do not hand-rewrite PromptKit
bodies). Workflows under `.callee/prism/workflows/` are authored Sequential/Loop
graphs that reference these Roles.
...
Provider for all Roles: **`grok`**. Permissions: default / **`ask`**.
...
```text
.callee/prism/roles/interviewer.md
.callee/prism/roles/explorer.md
.callee/prism/roles/architect.md
.callee/prism/roles/breakdown.md
.callee/prism/roles/implementer.md
.callee/prism/roles/reviewer.md
```
...
callee promptkit role create prism/roles/interviewer \
  ...
  --output .callee/prism/roles/interviewer.md \
  --force
...
callee promptkit role create prism/roles/explorer \
  ...
  --output .callee/prism/roles/explorer.md \
  --force
...
callee promptkit role create prism/roles/architect \
  ...
  --persona software-architect \
  --output .callee/prism/roles/architect.md \
  --force
...
callee promptkit role create prism/roles/breakdown \
  ...
  --persona software-architect \
  --output .callee/prism/roles/breakdown.md \
  --force
...
callee promptkit role create prism/roles/implementer \
  ...
  --output .callee/prism/roles/implementer.md \
  --force
...
callee promptkit role create prism/roles/reviewer \
  ...
  --output .callee/prism/roles/reviewer.md \
  --force
```
...
```bash
callee agent validate .callee/prism/roles/<id>.md
...
```text
.callee/prism/workflows/design.md
.callee/prism/workflows/apply.md
.callee/prism/workflows/verify.md
```
...
```bash
callee agent validate .callee/prism/workflows/design.md
callee agent validate .callee/prism/workflows/apply.md
callee agent validate .callee/prism/workflows/verify.md
